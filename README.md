...
I've tested and used these files to generate a live ELK deployment on Azure. They can be used to either recreate the entire deployment pictured above. Alternatively, select portions of the playbook file may be used to install only certain pieces of it, such as Filebeat.
...
|----------|----------|------------|------------------|
| Jumpbox  | Gateway  | 10.2.0.4   |Linux ubuntu 18.04|
| DVWA-VM1 | VM       | 10.2.0.7   |Linux ubuntu 18.04|
| DVWA-VM2 | VM       | 10.2.0.8   |Linux ubuntu 18.04|
| ELK VM   | ElkStack | 10.2.0.9  |Linux ubuntu 18.04|
...
- Update the hosts file to include webservers 10.2.0.7, 10.2.0.8
